...
public class Terrain {
	...
	public Terrain() {
		...
		v = new Vector[] { new Vector(-0.5, -1, -0.5), new Vector(-5, -1, 3), new Vector(-9, -1, 15),
				new Vector(-7, -1, 23), new Vector(-3, -1, 29), new Vector(1, -1, 30), new Vector(7, -1, 27),
				new Vector(9.5, -1, 21), new Vector(10, -1, 16), new Vector(7, -1, 8), new Vector(4, -1, 3),
				new Vector(1, -1, -0.5), };
		land[0] = new Polygon3D(v, new Vector(-10, -1, 30), new Vector(10, -1, 30), new Vector(-10, -1, -0.5),
				Main.textures[0], 20.0, 30.0, 1);
		border = land[0];

		v = new Vector[] { new Vector(-5, -1, 3), new Vector(-0.5, -1, -0.5), new Vector(-1, -1, -2),
				new Vector(-7.1, -1, 2.7) };
		land[14] = new Polygon3D(v, new Vector(-4.97, -1, 3), new Vector(-0.47, -1, -0.5), new Vector(-6.185, -1, 1),
				Main.textures[2], 4, 1.5, 1);

		v = new Vector[] { new Vector(-0.5, -1, -0.5), new Vector(1, -1, -0.5), new Vector(1.8, -1, -2),
				new Vector(-1, -1, -2) };
		land[15] = new Polygon3D(v, new Vector(-0.5, -1, -0.48), new Vector(1, -1, -0.48), new Vector(-0.5, -1, -2.01),
				Main.textures[2], 1.4, 1, 1);

		v = new Vector[] { new Vector(-9, -1, 15), new Vector(-5, -1, 3), new Vector(-7.1, -1, 2.7),
				new Vector(-11, -1, 15) };
		land[16] = new Polygon3D(v, new Vector(-8.97, -1, 15), new Vector(-4.97, -1, 3), new Vector(-10.5, -1, 15),
				Main.textures[2], 8, 0.68, 1);

		v = new Vector[] { new Vector(-7, -1, 23), new Vector(-9, -1, 15), new Vector(-11, -1, 15),
				new Vector(-9, -1, 23.3) };
		land[17] = new Polygon3D(v, new Vector(-6.9, -1, 23), new Vector(-8.9, -1, 15), new Vector(-9, -1, 23.3),
				Main.textures[2], 5, 1, 1);

		v = new Vector[] { new Vector(-3, -1, 29), new Vector(-7, -1, 23), new Vector(-9, -1, 23.3),
				new Vector(-4.5, -1, 30) };
		land[18] = new Polygon3D(v, new Vector(-3, -1, 28.9), new Vector(-7, -1, 22.9), new Vector(-4.5, -1, 30),
				Main.textures[2], 5, 0.98, 1);

		v = new Vector[] { new Vector(1, -1, 30), new Vector(-3, -1, 29), new Vector(-4.5, -1, 30),
				new Vector(0.979, -1, 31.6) };
		land[19] = new Polygon3D(v, new Vector(1, -1, 29.9), new Vector(-3, -1, 28.9), new Vector(0.5, -1, 31.5),
				Main.textures[2], 3.5, 1.1, 1);

		v = new Vector[] { new Vector(7, -1, 27), new Vector(1, -1, 30), new Vector(0.979, -1, 31.6),
				new Vector(8.44, -1, 27.87) };
		land[20] = new Polygon3D(v, new Vector(7, -1, 26.9), new Vector(1, -1, 29.9), new Vector(8, -1, 28.3),
				Main.textures[2], 3.5, 1.1, 1);

		v = new Vector[] { new Vector(9.5, -1, 21), new Vector(7, -1, 27), new Vector(8.44, -1, 27.87),
				new Vector(11.0732, -1, 21.18) };
		land[21] = new Polygon3D(v, new Vector(9.48, -1, 21), new Vector(6.98, -1, 27), new Vector(10.89, -1, 21.65),
				Main.textures[2], 3.5, 0.9, 1);

		v = new Vector[] { new Vector(10, -1, 16), new Vector(9.5, -1, 21), new Vector(11.0732, -1, 21.18),
				new Vector(11.525, -1, 15.80) };
		land[22] = new Polygon3D(v, new Vector(9.98, -1, 16), new Vector(9.48, -1, 21), new Vector(11.599, -1, 16.1),
				Main.textures[2], 3.5, 1.02, 1);

		v = new Vector[] { new Vector(7, -1, 8), new Vector(10, -1, 16), new Vector(11.525, -1, 15.80),
				new Vector(8.328, -1, 7.03) };
		land[23] = new Polygon3D(v, new Vector(6.98, -1, 8), new Vector(9.98, -1, 16), new Vector(8.5, -1, 7.5),
				Main.textures[2], 6, 1, 1);

		v = new Vector[] { new Vector(4, -1, 3), new Vector(7, -1, 8), new Vector(8.328, -1, 7.03),
				new Vector(5.342, -1, 2.194) };
		land[24] = new Polygon3D(v, new Vector(3.98, -1, 3), new Vector(6.98, -1, 8), new Vector(5, -1, 2.4),
				Main.textures[2], 6, 0.72, 1);

		v = new Vector[] { new Vector(1, -1, -0.5), new Vector(4, -1, 3), new Vector(5.342, -1, 2.194),
				new Vector(1.8, -1, -2) };
		land[25] = new Polygon3D(v, new Vector(0.98, -1, -0.5), new Vector(3.98, -1, 3), new Vector(2.2, -1, -1.5),
				Main.textures[2], 3, 0.97, 1);

		v = new Vector[] { new Vector(-1, -1, -2), new Vector(1.8, -1, -2), new Vector(1.8, -1, -4),
				new Vector(-1, -1, -4) };
		land[1] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(-7.1, -1, 2.7), new Vector(-1, -1, -2), new Vector(-1, -1, -4),
				new Vector(-7.1, -1, -2) };
		land[2] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(-11, -1, 15), new Vector(-7.1, -1, 2.7), new Vector(-7.1, -1, 0),
				new Vector(-11, -1, 0) };
		land[3] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(-13, -1, 22), new Vector(-11, -1, 22), new Vector(-11, -1, 5),
				new Vector(-13, -1, 5) };
		land[4] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(-9, -1, 23.3), new Vector(-11, -1, 15), new Vector(-11, -1, 25),
				new Vector(-9, -1, 26.3) };
		land[5] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(-4.5, -1, 30), new Vector(-9, -1, 23.3), new Vector(-9, -1, 29.3),
				new Vector(-4.5, -1, 32) };
		land[6] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(0.979, -1, 31.4), new Vector(-4.5, -1, 30), new Vector(-4.5, -1, 32),
				new Vector(0.979, -1, 33.5) };
		land[7] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(8.44, -1, 27.87), new Vector(0.979, -1, 31.6), new Vector(0.979, -1, 33.6),
				new Vector(8.44, -1, 29.87) };
		land[8] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(11.0732, -1, 21.18), new Vector(8.44, -1, 27.87), new Vector(8.44, -1, 29.87),
				new Vector(11.0732, -1, 27.18) };
		land[9] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(11.525, -1, 15.80), new Vector(11.0732, -1, 21.18),
				new Vector(11.0732, -1, 29.18), new Vector(13.525, -1, 15.80) };
		land[10] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(8.328, -1, 7.03), new Vector(11.525, -1, 15.80), new Vector(13.525, -1, 15.80),
				new Vector(10.328, -1, 7.03) };
		land[11] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(5.342, -1, 2.194), new Vector(8.328, -1, 7.03), new Vector(11.328, -1, 7.03),
				new Vector(8.342, -1, 2.194) };
		land[12] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);

		v = new Vector[] { new Vector(1.8, -1, -2), new Vector(5.342, -1, 2.194), new Vector(7.342, -1, 2.194),
				new Vector(1.8, -1, -4) };
		land[13] = new Polygon3D(v, new Vector(-1, -1, -2), new Vector(1, -1, -2), new Vector(-1, -1, -4),
				Main.textures[3], 1, 1, 1);
		...
		double x = 2;
		double y = 1;
		v = new Vector[] { new Vector(-1, -1, -0.6), new Vector(1.3, -1, -0.6), new Vector(1.8, -1, -4),
				new Vector(-1, -1, -4) };
		water[0] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(-5, -1, 2.7), new Vector(-1, -1, -0.6), new Vector(-1, -1, -4),
				new Vector(-7.1, -1, -2) };
		water[1] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(-9.2, -1, 15), new Vector(-5, -1, 2.7), new Vector(-7.1, -1, -2),
				new Vector(-12, -1, 15) };
		water[2] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(-7.1, -1, 23), new Vector(-9.2, -1, 15), new Vector(-12, -1, 15),
				new Vector(-10, -1, 23.3) };
		water[3] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(-3.1, -1, 29), new Vector(-7.1, -1, 23), new Vector(-10, -1, 23.3),
				new Vector(-6, -1, 31) };
		water[4] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(1, -1, 30.2), new Vector(-3.1, -1, 29), new Vector(-6, -1, 31),
				new Vector(1, -1, 34) };
		water[5] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(7, -1, 27.2), new Vector(1, -1, 30.2), new Vector(1, -1, 34),
				new Vector(9, -1, 30) };
		water[6] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(9.6, -1, 21), new Vector(7, -1, 27.2), new Vector(9, -1, 30),
				new Vector(13.5, -1, 21) };
		water[7] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(10.1, -1, 16), new Vector(9.6, -1, 21), new Vector(13.5, -1, 21),
				new Vector(13.5, -1, 16) };
		water[8] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(7.1, -1, 8), new Vector(10.1, -1, 16), new Vector(13.5, -1, 16),
				new Vector(10.5, -1, 7.5) };
		water[9] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(4.2, -1, 3), new Vector(7.1, -1, 8), new Vector(10.5, -1, 7.5),
				new Vector(7, -1, 1) };
		water[10] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		v = new Vector[] { new Vector(1.3, -1, -0.6), new Vector(4.2, -1, 3), new Vector(7, -1, 1),
				new Vector(1.8, -1, -4) };
		water[11] = new Polygon3D(v, new Vector(-1, -1, 1), new Vector(1, -1, 1), new Vector(-1, -1, -1),
				Main.textures[4], x, y, 5);

		// create road
		road = new Polygon3D[18];
		v = new Vector[] { new Vector(-1, -1, 1), new Vector(-1, -1, 1.4), new Vector(1, -1, 1.4),
				new Vector(1, -1, 1) };
		road[0] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 8, 1);

		v = new Vector[] { new Vector(-1.5, -1, 1.1), new Vector(-1.5, -1, 1.53), new Vector(-1, -1, 1.4),
				new Vector(-1, -1, 1) };
		road[1] = new Polygon3D(v, new Vector(-1.5, -1, 1.15), new Vector(-1.5, -1, 1.5), v[3], Main.textures[1], 1, 2,
				1);

		v = new Vector[] { new Vector(-2, -1, 1.3), new Vector(-2, -1, 1.75), new Vector(-1.5, -1, 1.53),
				new Vector(-1.5, -1, 1.1) };
		road[2] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 2, 1);

		v = new Vector[] { new Vector(-2.5, -1, 1.6), new Vector(-2.5, -1, 2.2), new Vector(-2, -1, 1.75),
				new Vector(-2, -1, 1.3) };
		road[3] = new Polygon3D(v, new Vector(-2.5, -1, 1.55), new Vector(-2.5, -1, 2.15), new Vector(-2, -1, 1.2),
				Main.textures[1], 1, 2, 1);

		v = new Vector[] { new Vector(-4.6, -1, 3.6), new Vector(-4.4, -1, 4.1), new Vector(-2.5, -1, 2.2),
				new Vector(-2.5, -1, 1.6) };
		road[4] = new Polygon3D(v, v[0], v[1], new Vector(-2.5, -1, 1.55), Main.textures[1], 1, 10, 1);

		v = new Vector[] { new Vector(-4.9, -1, 4), new Vector(-4.4, -1, 4.1), new Vector(-4.6, -1, 3.6),
				new Vector(-4.6, -1, 3.6) };
		road[5] = new Polygon3D(v, v[0], v[1], v[2], Main.textures[1], 1, 1, 1);

		v = new Vector[] { new Vector(-7, -1, 10), new Vector(-6.5, -1, 10.2), new Vector(-4.4, -1, 4.1),
				new Vector(-4.9, -1, 4) };
		road[6] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 20, 1);

		v = new Vector[] { new Vector(1, -1, 1), new Vector(1, -1, 1.4), new Vector(1.3, -1, 1.4),
				new Vector(1.3, -1, 1) };
		road[7] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 0.1, 1);

		v = new Vector[] { new Vector(-7.9, -1, 15), new Vector(-7.4, -1, 15.2), new Vector(-6.5, -1, 10.2),
				new Vector(-7, -1, 10) };
		road[8] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 17, 1);

		v = new Vector[] { new Vector(-7.9, -1, 17.2), new Vector(-7.4, -1, 17.2), new Vector(-7.4, -1, 15.2),
				new Vector(-7.9, -1, 15) };
		road[9] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 7.2, 1);

		v = new Vector[] { new Vector(-7.5, -1, 19.2), new Vector(-7, -1, 19.2), new Vector(-7.4, -1, 17.2),
				new Vector(-7.9, -1, 17.2) };
		road[10] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 7.2, 1);

		v = new Vector[] { new Vector(-7, -1, 21.2), new Vector(-6.5, -1, 21.2), new Vector(-7, -1, 19.2),
				new Vector(-7.5, -1, 19.2) };
		road[11] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 7, 1);

		v = new Vector[] { new Vector(-6.6, -1, 22.2), new Vector(-6.1, -1, 22.2), new Vector(-6.5, -1, 21.2),
				new Vector(-7, -1, 21.2) };
		road[12] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 4.2, 1);

		v = new Vector[] { new Vector(-6.1, -1, 23.2), new Vector(-5.5, -1, 23.2), new Vector(-6.1, -1, 22.2),
				new Vector(-6.6, -1, 22.2) };
		road[13] = new Polygon3D(v, v[0], v[1], new Vector(-6.65, -1, 22.2), Main.textures[1], 1, 3.2, 1);

		v = new Vector[] { new Vector(-4.7, -1, 25.2), new Vector(-4.05, -1, 25.2), new Vector(-5.5, -1, 23.2),
				new Vector(-6.1, -1, 23.2) };
		road[14] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 7, 1);

		v = new Vector[] { new Vector(-2.4, -1, 27.786), new Vector(-2.2, -1, 27.4), new Vector(-4.05, -1, 25.2),
				new Vector(-4.7, -1, 25.2) };
		road[15] = new Polygon3D(v, new Vector(-2.65, -1, 27.45), new Vector(-2.4, -1, 27.2),
				new Vector(-4.6, -1, 25.2), Main.textures[1], 1, 9, 1);

		v = new Vector[] { new Vector(0.55, -1, 20), new Vector(0.95, -1, 20), new Vector(0.95, -1, 1.39),
				new Vector(0.55, -1, 1.39) };
		road[16] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 65, 1);

		v = new Vector[] { new Vector(-1.4, -1, 27.786), new Vector(-1.4, -1, 27.34), new Vector(-2.4, -1, 27.34),
				new Vector(-2.4, -1, 27.786) };
		road[17] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[1], 1, 4, 1);

		// These code are introduced after I have already hard-coded all the
		// polygons of land, water and road.
		// Then I realised that I needed to shift them 10 map units to the
		// right, 2 map units upg, in
		...
		v = new Vector[] { new Vector(8.4, -1, 22.85), new Vector(13.85, -1, 22.85), new Vector(13.85, -1, 18.15),
				new Vector(8.4, -1, 18.15) };
		concreteFloor[0] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[40], 6.5, 5.5, 1);

		v = new Vector[] { new Vector(17.86, -1, 16.9), new Vector(18.9, -1, 16.9), new Vector(18.9, -1, 15.86),
				new Vector(17.86, -1, 15.86) };
		concreteFloor[1] = new Polygon3D(v, v[0], v[1], v[3], Main.textures[40], 1, 1, 1);

		v = new Vector[] { new Vector(3.86, -1, 14.4), new Vector(4.9, -1, 14.4), new Vector(4.9, -1, 13.36),
